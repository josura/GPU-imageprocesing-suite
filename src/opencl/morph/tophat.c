...
int main(int argc, char ** args){
	...
	// DILATION
	dilation_evt = dilation(dilation_k, que, d_output, d_tmp,d_strel, height, width, strel_height,strel_width);
	...
	difference_evt = difference(difference_k, que, d_output, d_input,d_tmp, height, width, height,width);
